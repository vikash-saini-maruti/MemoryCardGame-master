...
def GameModePick(win):
    ...
    img3 = Image(Point(400,280), 'exit_button.png')
    img3.draw(win)
    ...
    while(gamemode < 0):
        ...
        if(point.x < 310 and point.x > 90 and point.y < 230 and point.y > 190):
            ...
            if(point.x < 720 and point.x > 470 and point.y < 230 and point.y > 190):
                gamemode = 1
            elif(point.x < 720 and point.x > 470 and point.y < 230 and point.y > 190):
                gamemode = 2
            else:
                gamemode = -1
...
def ScoreBoard(win, move, key, mouse):
    ...
    pause_txt = Text(Point(100, 280), "Pause game " )
    pause_txt.setStyle('bold')
    pause_txt.draw(win)
    
    pause_txt = Text(Point(100, 350), "Sound" )
    pause_txt.setStyle('bold')
    pause_txt.draw(win)
